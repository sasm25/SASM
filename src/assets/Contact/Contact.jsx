          ...
          {/* <div className="text-gray-200 text-lg mb-6 relative">
            <div className="text-lg text-right absolute right-0">
              <p className="text-gray-200 font-semibold">
                Email:{" "}
                <a
                  href="mailto:hod.pe@bitsindri.ac.in"
                  className="text-blue-600 hover:underline"
                >
                  hod.pe@bitsindri.ac.in
                </a>
              </p>
              <p className="text-gray-200 font-semibold">
                Contact :{" "}
...
"
            ...
            <p className="mb-2">
              Head of Department Production & Industrial Engineering
            </p>
...
"
          ...
          <div className="text-gray-200 text-lg mb-6 relative">
            ...
            <p className="mb-2">Professor & HOD</p>
            <p className="mb-2">Production & Industrial Engineering</p>
            <p className="mb-2">BIT Sindri, Dhanbad</p>
          </div>
          <br />
          <div className="text-gray-200 text-lg mb-6 relative">
            <div className="text-lg text-right absolute right-0">
              <p className="text-gray-200 font-semibold">
                Email:{" "}
                <a
                  href="mailto:sumanta.prod@bitsindri.ac.in"
                  className="text-blue-600 hover:underline"
                >
                  sumanta.prod@bitsindri.ac.in
                </a>
              </p>
              <p className="text-gray-200 font-semibold">
                Phone:{" "}
                <a
                  href="tel:+918637396668"
                  className="text-blue-500 hover:underline"
                >
                  +91-8637396668
                </a>
            ...
            <p className="mb-2 text-xl">
              <strong>Dr. Sumanta Mukherjee</strong>
            </p>
